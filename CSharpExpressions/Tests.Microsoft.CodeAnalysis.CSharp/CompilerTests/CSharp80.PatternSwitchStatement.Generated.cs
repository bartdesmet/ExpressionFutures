...
namespace Tests.Microsoft.CodeAnalysis.CSharp
{
    public partial class CompilerTests_CSharp80_PatternSwitchStatement
    {
        ...
        public void CompilerTest_EF4A_69D6()
        {
            ...
            var actual = GetDebugView(@"(Expression<Action<object>>)(o => { switch (o) { case string { Length: 0 }: Console.WriteLine(""Empty""); break; case string { Length: 1 } s: Console.Write(s[0]); break; } })");
            var expected = @"
    ...
    <CSharpBlock Type=""System.Void"">
          ...
          <Sections>
            <SwitchSection>
              <Labels>
                <SwitchLabel>
                  <Label>
                    <LabelTarget Type=""System.Void"" Id=""1"" Name=""case string { Length: 0 }:"" />
                  </Label>
                  <Pattern>
                    <RecursivePattern InputType=""System.Object"" NarrowedType=""System.String"" Type=""System.String"">
                      <Properties>
                        <Property>
                          <Member>
              ...
              <Statements>
                <Call Type=""System.Void"" Method=""Void WriteLine(System.String)"">
                  <Arguments>
                    <Constant Type=""System.String"" Value=""Empty"" />
                  </Arguments>
                </Call>
            ...
            <SwitchSection>
              <Locals>
                <Parameter Type=""System.String"" Id=""3"" Name=""s"" />
              </Locals>
              <Labels>
                <SwitchLabel>
                  <Label>
                    <LabelTarget Type=""System.Void"" Id=""4"" Name=""case string { Length: 1 } s:"" />
                  </Label>
                  <Pattern>
                    <RecursivePattern InputType=""System.Object"" NarrowedType=""System.String"" Type=""System.String"">
                      <Variable>
      ...
      <ReturnLabel>
        ...
        public void CompilerTest_1C06_9AD6()
        {
            ...
            var actual = GetDebugView(@"(Expression<Action<object>>)(o => { switch (o) { case (0, 0): Console.WriteLine(""Origin""); break; } })");
            var expected = @"
<Lambda Type=""System.Action`1[System.Object]"">
  <Parameters>
    <Parameter Type=""System.Object"" Id=""0"" Name=""o"" />
    ...
    <CSharpBlock Type=""System.Void"">
          ...
          <Sections>
            <SwitchSection>
              <Labels>
                <SwitchLabel>
                  <Label>
                    <LabelTarget Type=""System.Void"" Id=""1"" Name=""case (0, 0):"" />
                  </Label>
                  <Pattern>
              ...
              <Statements>
                <Call Type=""System.Void"" Method=""Void WriteLine(System.String)"">
                  <Arguments>
                    <Constant Type=""System.String"" Value=""Origin"" />
                  </Arguments>
                </Call>
                <Goto Type=""System.Void"" Kind=""Break"">
                  <Target>
      ...
      <ReturnLabel>
        ...
        public void CompilerTest_0A27_89A9()
        {
            ...
            var actual = GetDebugView(@"(Expression<Action<(int, int)>>)(o => { switch (o) { case (0, 0) p: Console.WriteLine(p); break; } })");
            var expected = @"
<Lambda Type=""System.Action`1[System.ValueTuple`2[System.Int32,System.Int32]]"">
  <Parameters>
    <Parameter Type=""System.ValueTuple`2[System.Int32,System.Int32]"" Id=""0"" Name=""o"" />
  </Parameters>
  <Body>
    <CSharpBlock Type=""System.Void"">
      <Statements>
        <CSharpSwitch Type=""System.Void"">
          ...
          <Sections>
            <SwitchSection>
              <Locals>
                <Parameter Type=""System.ValueTuple`2[System.Int32,System.Int32]"" Id=""1"" Name=""p"" />
              </Locals>
              <Labels>
                <SwitchLabel>
                  <Label>
                    <LabelTarget Type=""System.Void"" Id=""2"" Name=""case (0, 0) p:"" />
                  </Label>
                  <Pattern>
                    <RecursivePattern InputType=""System.ValueTuple`2[System.Int32,System.Int32]"" NarrowedType=""System.ValueTuple`2[System.Int32,System.Int32]"">
                      <Variable>
                        <Parameter Type=""System.ValueTuple`2[System.Int32,System.Int32]"" Id=""1"" Name=""p"" />
                      </Variable>
                      <Deconstruction>
      ...
      <ReturnLabel>
        ...
        partial class Review { /* override in .Verify.cs */ public virtual void CompilerTest_0A27_89A9() => INCONCLUSIVE(); }
...
namespace Tests.Microsoft.CodeAnalysis.CSharp
{
    partial class CompilerTests_CSharp80_PatternSwitchStatement
    {
        partial class Reviewed
        {
            public override void CompilerTest_EF4A_69D6() => OK();
            public override void CompilerTest_1C06_9AD6() => OK();
            public override void CompilerTest_0A27_89A9() => OK();
        }
    }
}
*/
