...
{
    [TestClass]
    public partial class CompilerTests_CSharp100_PatternMatching
    {
        [TestMethod]
        public void CompilerTest_8652_50C0()
        {
            // (Expression<Func<MethodCallExpression, bool>>)(o => o is { Method.Name: "Foo" })
            var actual = GetDebugView(@"(Expression<Func<MethodCallExpression, bool>>)(o => o is { Method.Name: ""Foo"" })");
            var expected = @"
<Lambda Type=""System.Func`2[System.Linq.Expressions.MethodCallExpression,System.Boolean]"">
  <Parameters>
    <Parameter Type=""System.Linq.Expressions.MethodCallExpression"" Id=""0"" Name=""o"" />
  </Parameters>
  <Body>
    <CSharpIsPattern Type=""System.Boolean"">
      ...
      <Pattern>
        <RecursivePattern InputType=""System.Linq.Expressions.MethodCallExpression"" NarrowedType=""System.Linq.Expressions.MethodCallExpression"">
          <Properties>
            <Property>
              <Member>
                <PropertyCSharpSubpatternMember Member=""System.String Name"">
                  <Receiver>
                    <PropertyCSharpSubpatternMember Member=""System.Reflection.MethodInfo Method"" />
                  </Receiver>
                </PropertyCSharpSubpatternMember>
              </Member>
              <Pattern>
            ...
            Verify.CompilerTest_8652_50C0();
        }

        partial class Review { /* override in .Verify.cs */ public virtual void CompilerTest_8652_50C0() => INCONCLUSIVE(); }
...
namespace Tests.Microsoft.CodeAnalysis.CSharp
{
    partial class CompilerTests_CSharp100_PatternMatching
    {
        partial class Reviewed
        {
            public override void CompilerTest_8652_50C0() => OK();
        }
    }
}
*/
