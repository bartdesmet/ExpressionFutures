...
namespace Tests.Microsoft.CodeAnalysis.CSharp
{
    public partial class CompilerTests_CSharp30_Statements_Try_Reducing
    {
        ...
        public void CompilerTest_77C7_2219()
        {
            ...
            var actual = ToCSharp(@"(Expression<Action>)(() => { try { Console.Write('T'); } catch (Exception e) when (e is ArgumentException a) { Console.WriteLine(a); } finally { Console.Write('F'); } })", reduce: true);
            var expected = @"
() =>
{
    {
        ...
        try
        {
            ...
            bool __test;
            __test = e is ArgumentException;
            if (__test)
                a = (ArgumentException)e;
            /*return*/ __test/*;*/
        })
        {
            Console.WriteLine(a);
    ...
    L0 /*(null)*/:
        ...
        partial class Review { /* override in .Verify.cs */ public virtual void CompilerTest_77C7_2219() => INCONCLUSIVE(); }
...
namespace Tests.Microsoft.CodeAnalysis.CSharp
{
    partial class CompilerTests_CSharp30_Statements_Try_Reducing
    {
        partial class Reviewed
        {
            public override void CompilerTest_77C7_2219() => OK();
        }
    }
}
*/
