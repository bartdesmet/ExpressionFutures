...
namespace Tests
{
    ...
    public class ForTests
    {
        ...
        public void For_Update()
        {
            ...
            Assert.AreSame(res, res.Update(res.BreakLabel, res.ContinueLabel, res.Initializers, res.Test, res.Iterators, res.Body));
            ...
            var upd1 = res.Update(newBreakLabel, res.ContinueLabel, res.Initializers, res.Test, res.Iterators, res.Body);
            var upd2 = res.Update(res.BreakLabel, newContinueLabel, res.Initializers, res.Test, res.Iterators, res.Body);
            var upd3 = res.Update(res.BreakLabel, res.ContinueLabel, newInitializers, res.Test, res.Iterators, res.Body);
            var upd4 = res.Update(res.BreakLabel, res.ContinueLabel, res.Initializers, newTest, res.Iterators, res.Body);
            var upd5 = res.Update(res.BreakLabel, res.ContinueLabel, res.Initializers, res.Test, newIterators, res.Body);
            var upd6 = res.Update(res.BreakLabel, res.ContinueLabel, res.Initializers, res.Test, res.Iterators, newBody);
            ...
            Assert.IsTrue(newInitializers.SequenceEqual(upd3.Initializers));
            ...
            Assert.AreSame(res.Initializers, upd4.Initializers);
            ...
            Assert.AreSame(res.Test, upd5.Test);
            Assert.IsTrue(newIterators.SequenceEqual(upd5.Iterators));
            ...
            Assert.AreSame(res.Iterators, upd6.Iterators);
