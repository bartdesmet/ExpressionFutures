...
namespace System.Linq.Expressions.Compiler
{
    ...
    static partial class DelegateHelpers
    {
        ...
        private static readonly Lazy<MethodInfo> s_0 = new Lazy<MethodInfo>(() => s_mtds["MakeCallSiteDelegate"].Single(m => m.IsStatic && m.GetParameters().Select(p => p.ParameterType).SequenceEqual(new Type[] { typeof(System.Collections.ObjectModel.ReadOnlyCollection<System.Linq.Expressions.Expression>), typeof(System.Type) })));
